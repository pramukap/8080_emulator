...
static const data instruction_set_data[256] = 
{
	...
	/*D0*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "RNC", 1, NONE, },
		{ph8_ptr, ph8_ptr, d_pair, ph16_ptr, "POP D", 1, NONE, },
	/*D2*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "JNC ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "OUT D8", 2, NONE, },
	/*D4*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "CNC ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, d_pair, ph16_ptr, "PUSH D", 1, NONE, },
	/*D6*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "SUI D8", 2, ALL, },
		{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "RST 2", 1, NONE, },
	/*D8*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "RC", 1, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "NOP", 1, NONE, },
	/*DA*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "JC ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "IN D8", 2, NONE, },
	/*DC*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "CC ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "NOP", 1, NONE, },
	/*DE*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "SBI D8", 2, ALL, },
		{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "RST 3", 1, NONE, },
	/*E0*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "RPO", 1, NONE, },
		{ph8_ptr, ph8_ptr, h_pair, ph16_ptr, "POP H", 1, NONE, },
	/*E2*/	{ph8_ptr ph8_ptr, ph16_ptr, ph16_ptr, "JPO ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "XTHL", 1, NONE, },
	/*E4*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "CPO ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, h_pair, ph16_ptr, "PUSH H", 1, NONE, },
	/*E6*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "ANI D8", 2, ALL, },
		{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "RST 4", 1, NONE, },
	/*E8*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "RPE", 1, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "PCHL", 1, NONE, },
	/*EA*/	{ph8_ptr, ph8_ptr, ph16_ptr, ph16_ptr, "JPE ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, "XCHG", 1, NONE, },
	/*EC*/	{ph8_ptr, ph8_ptr, ph16_ptr, "CPE ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, "NOP", 1, NONE, },
	/*EE*/	{ph8_ptr, ph8_ptr, ph16_ptr, "XRI D8", 2, ALL, },
		{ph8_ptr, ph8_ptr, ph16_ptr, "RST 5", 1, NONE, },
	/*F0*/	{ph8_ptr, ph8_ptr, ph16_ptr, "RP", 1, NONE, },
		{ph8_ptr, ph8_ptr, psw, "POP PSW", 1, NONE, },
	/*F2*/	{ph8_ptr, ph8_ptr, ph16_ptr, "JP ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, "DI", 1, NONE, },
	/*F4*/	{ph8_ptr, ph8_ptr, ph16_ptr, "CP ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, psw, "PUSH PSW", 1, NONE, },
	/*F6*/	{ph8_ptr, ph8_ptr, ph16_ptr, "ORI D8", 2, ALL, },
		{ph8_ptr, ph8_ptr, ph16_ptr, "RST 6", 1, NONE, },
	/*F8*/	{ph8_ptr, ph8_ptr, ph16_ptr, "RM", 1, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, "SPHL", 1, NONE, },
	/*FA*/	{ph8_ptr, ph8_ptr, ph16_ptr, "JM ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, "EI", 1, NONE, },
	/*FC*/	{ph8_ptr, ph8_ptr, ph16_ptr, "CM ADR", 3, NONE, },
		{ph8_ptr, ph8_ptr, ph16_ptr, "NOP", 1, NONE, },
	/*FE*/	{ph8_ptr, ph8_ptr, ph16_ptr, "CPI D8", 2, ALL, },
		{ph8_ptr, ph8_ptr, ph16_ptr, "RST 7", 1, NONe, }	
};
